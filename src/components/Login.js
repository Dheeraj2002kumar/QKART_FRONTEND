...
const Login = () => {
  ...
  const [loader, setLoader] = useState(false); // Add state to control loading spinner
   ...
   */
   ...
   const login = async (formData) => {
    setLoader(true); // Show the loader when the request starts
    ...
    try {
      ...
      setLoader(false); // Hide the loader once the request is finished
    }
  };
